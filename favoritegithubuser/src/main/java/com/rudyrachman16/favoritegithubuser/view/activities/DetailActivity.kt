...
import com.rudyrachman16.favoritegithubuser.databinding.ActivityDetailBinding
...
import com.rudyrachman16.favoritegithubuser.view.adapters.TabAdapter
import com.rudyrachman16.favoritegithubuser.view.viewmodel.DetailViewModel
...
class DetailActivity : AppCompatActivity(), CoroutineScope {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val user: User = intent.getParcelableExtra(FavoriteActivity.USER_KEY)
...
//        ).get(DetailViewModel::class.java)
        ...
        launch(coroutineContext) {
            val job = launch(Dispatchers.IO) {
                ...
                val cur = contentResolver.query(uri, null, null, null, null)!!.apply {
                    moveToFirst()
                    fav = getInt(getColumnIndexOrThrow("result")) > 0
                }
                cur.close()
            }
            job.join()
